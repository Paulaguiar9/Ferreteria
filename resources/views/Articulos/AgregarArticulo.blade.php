                        ...
                        <div class="card mb-4">
                           ...
                           <form action="{{url('/guardarArticulo')}}" method="POST" enctype="multipart/form-data">
                           	@csrf
                                ...
                                <input type="text" class="form-control{{ $errors->has('NombreArticulo') ? ' is-invalid' : '' }}" id="NombreArticulo" placeholder="Ingrese nombre del articulo" value="" required="" name="NombreArticulo">
                           ...
                           <div class="form-group">
                                 ...
                                 <input type="text" class="form-control{{ $errors->has('Descripcion') ? ' is-invalid' : '' }}" id="Descripcion" placeholder="Ingrese Descripcio" value="" required="" name="Descripcion">
                            ...
                            <!-- cedula -->
                                 ...
                                 <input type="text" class="form-control{{ $errors->has('Cantidad') ? ' is-invalid' : '' }}" id="Cantidad" placeholder="Ingrese la cantidad" value="" required="" name="Cantidad">
                            ...
                            <!-- Télefono -->
                                ...
                                <input type="text" class="form-control{{ $errors->has('Precio') ? ' is-invalid' : '' }}" id="Precio" placeholder="Ingrese el Precio" value="" name="Precio" required="">
