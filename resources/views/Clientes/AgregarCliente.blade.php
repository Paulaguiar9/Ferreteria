                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                           ...
                           <form action="{{url('/guardarCliente')}}" method="POST" enctype="multipart/form-data">
                           	@csrf
                            ...
                            <!-- cedula -->
                                 ...
                                 <input type="text" class="form-control{{ $errors->has('Cedula') ? ' is-invalid' : '' }}" id="Cedula" placeholder="Ingrese cedula" value="" required="" name="Cedula">
                            ...
                            <!-- Télefono -->
                                ...
                                <input type="text" class="form-control{{ $errors->has('Telefono') ? ' is-invalid' : '' }}" id="Telefono" placeholder="Ingrese teléfono" value="" name="Telefono" required="">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control{{ $errors->has('Direccion') ? ' is-invalid' : '' }}" id="Direccion" name="Direccion" placeholder="Ingrese dirección" required="">
